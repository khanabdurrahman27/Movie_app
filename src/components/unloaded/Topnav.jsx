    ...
    return ( 
        ...
        <div className="w-[100%] h-[10vh] text-zinc-200 font-bold relative flex justify-center items-center">
            ...
            <div className="z-[100] absolute w-[50%] max-h-[50vh] bg-zinc-200 top-[100%] overflow-auto rounded-lg ">
                { searches.map((s,i)=>(
                     <Link  to={`${s.media_type}/details/${s.id}`} key={i} className="hover:text-black hover:bg-zinc-400 font-semibold text-zinc-600 w-[100%] p-10 flex justify-start items-center border-2 border-zinc-100">
